...
def one_channel_index(id):
    ...
    print(one_channel_messages, '---- HERE IS OUR CHANNEL! ------')
    ...
    print(one_channel_messages, "!! -- CHANNEL MESSAGES HERE -- !!")

    print("HERE IS OUR RESPONSE OBJECT::::", {"channel": one_channel, "messages": channel_messages} )
