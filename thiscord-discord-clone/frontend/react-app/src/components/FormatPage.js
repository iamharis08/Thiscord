...
function FormatPage() {
  ...
  // }
    ...
    return (
        <main>
            <div className="format-servers-list">
                <ServersList />
            </div>
            <div className="format-channels-bar">
                
            </div>
            <div className="format-body-container">
                <div className="format-channelsearch-bar">
                ...
                <div className="format-message-user-container">
                    <div className="format-messages-container">
                        ...
                        <div className="format-message-input">
                    ...
                    <div className="format-users-container">
